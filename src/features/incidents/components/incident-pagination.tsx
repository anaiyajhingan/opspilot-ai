...
/**
 * Pagination component for navigating through incident pages.
 */
export function IncidentPagination({ currentPage, totalPages, onPageChange }: IncidentPaginationProps) {
