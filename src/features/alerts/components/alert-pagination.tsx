...
/**
 * Pagination component for navigating through alert pages.
 */
export function AlertPagination({ currentPage, totalPages, onPageChange }: AlertPaginationProps) {
